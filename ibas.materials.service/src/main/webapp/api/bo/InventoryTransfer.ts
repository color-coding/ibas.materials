...
namespace materials {
    export namespace bo {
        ...
        /** 库存转储 */
        export interface IInventoryTransfer extends ibas.IBODocument {
        ...
        /** 库存转储-行 */
        export interface IInventoryTransferLine extends ibas.IBODocumentLine, IMaterialSerialItemParent, IMaterialBatchItemParent {
