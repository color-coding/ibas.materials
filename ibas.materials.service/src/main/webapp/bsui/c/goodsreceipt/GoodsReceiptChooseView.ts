...
import { IGoodsReceiptChooseView } from "../../../bsapp/goodsreceipt/index";

/**
 * 选择视图-库存收货
 */
export class GoodsReceiptChooseView extends ibas.BOChooseView implements IGoodsReceiptChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
