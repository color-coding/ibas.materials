...
import { IGoodsReceiptListView } from "../../../bsapp/goodsreceipt/index";

/**
 * 列表视图-库存收货
 */
export class GoodsReceiptListView extends ibas.BOListView implements IGoodsReceiptListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                openui5.utils.getTableSelecteds<bo.GoodsReceipt>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                openui5.utils.getTableSelecteds<bo.GoodsReceipt>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.GoodsReceipt[] {
        return openui5.utils.getTableSelecteds<bo.GoodsReceipt>(this.table);
    }
}
