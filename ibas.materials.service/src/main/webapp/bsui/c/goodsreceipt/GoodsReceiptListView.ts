...
export class GoodsReceiptListView extends ibas.BOListView implements IGoodsReceiptListView {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.GoodsReceipt>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.GoodsReceipt>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.GoodsReceipt[] {
        return utils.getTableSelecteds<bo.GoodsReceipt>(this.table);
    }
}
