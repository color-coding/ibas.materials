...
import { IInventoryTransferChooseView } from "../../../bsapp/inventorytransfer/index";

/**
 * 选择视图-库存转储
 */
export class InventoryTransferChooseView extends ibas.BOChooseView implements IInventoryTransferChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
