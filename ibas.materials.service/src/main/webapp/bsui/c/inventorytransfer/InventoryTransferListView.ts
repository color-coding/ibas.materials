...
import { IInventoryTransferListView } from "../../../bsapp/inventorytransfer/index";

/**
 * 列表视图-库存转储
 */
export class InventoryTransferListView extends ibas.BOListView implements IInventoryTransferListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.InventoryTransfer>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.InventoryTransfer>(that.table)
                            );
                        }
                    }),
                ],
    ...
    getSelecteds(): bo.InventoryTransfer[] {
        return utils.getTableSelecteds<bo.InventoryTransfer>(this.table);
    }
}
