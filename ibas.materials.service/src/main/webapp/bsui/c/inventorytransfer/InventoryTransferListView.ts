...
namespace materials {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-库存转储
             */
            export class InventoryTransferListView extends ibas.BOListView implements app.IInventoryTransferListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_inventorytransfer_canceled"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "canceled",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_inventorytransfer_ordertype"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_inventorytransfer_dataowner"),
                            ...
                            content: [
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (event: sap.ui.base.Event): void {
                                        ...
                                        for (let item of that.table.getSelecteds<bo.InventoryTransfer>()) {
                                            criteria.result++;
