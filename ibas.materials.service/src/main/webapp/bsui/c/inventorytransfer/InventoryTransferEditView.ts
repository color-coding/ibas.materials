                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_inventorytransfer_postingdate"),
                            }),
                            new sap.extension.m.DatePicker("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                        ...
                        content: [
                            ...
                            this.tableInventoryTransferLine = new sap.extension.table.DataTable("", {
                                ...
                                toolbar: new sap.m.Toolbar("", {
                                    content: [
                                        new sap.m.MenuButton("", {
                                            ...
                                            defaultAction(): void {
                                                that.fireViewEvents(that.addInventoryTransferLineEvent, 1);
                                            }
                                        }),
                                        new sap.m.Button("", {
                                        ...
                                        new sap.m.Label("", { showColon: true, text: ibas.i18n.prop("bo_inventorytransfer_fromwarehouse") }),
                                        ...
                                        new sap.m.Label("", { showColon: true, text: ibas.i18n.prop("bo_inventorytransfer_towarehouse") })
                                ...
                                columns: [
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                ...
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.chooseInventoryTransferLineMaterialEvent, this.getBindingContext().getObject(), null, this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                                ...
                                                if (typeof data === "string") {
                                                    if (data?.indexOf("\n") > 0) {
                                                        sap.extension.tables.fillingCellsData(source, data,
                                                            (rowCount) => {
                                                                that.fireViewEvents(that.addInventoryTransferLineEvent, rowCount);
                                                                return true;
                                                            },
                                                            (cell, value) => {
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.chooseInventoryTransferLineWarehouseEvent, this.getBindingContext().getObject(), ibas.emDirection.OUT, this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.chooseInventoryTransferLineWarehouseEvent, ibas.emDirection.IN, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                                new ibas.Condition(materials.bo.Warehouse.PROPERTY_ACTIVATED_NAME, ibas.emConditionOperation.EQUAL, ibas.emYesNo.YES)
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_inventorytransferline_distributionrule1"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.chooseInventoryTransferLineDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_inventorytransferline_distributionrule2"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.chooseInventoryTransferLineDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_inventorytransferline_distributionrule3"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.chooseInventoryTransferLineDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_inventorytransferline_distributionrule4"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.chooseInventoryTransferLineDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_inventorytransferline_distributionrule5"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.chooseInventoryTransferLineDistributionRuleEvent,
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", {
                                text: ibas.i18n.prop("bo_inventorytransfer_branch"),
                                        ...
                                        items: [
                                            new sap.m.MenuItem("", {
                                                ...
                                                press: function (): void {
                                                    ...
                                                    if (data instanceof bo.InventoryTransfer) {
