                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_inventorytransferrequest_docnum") }),
                            new sap.extension.m.Input("", {
                            }).bindProperty("bindingValue", {
                                path: "docNum",
                                type: new sap.extension.data.Alphanumeric({
                            ...
                            new sap.extension.m.SeriesSelect("", {
                                objectCode: bo.BO_CODE_INVENTORYTRANSFERREQUEST,
                            }).bindProperty("bindingValue", {
                                path: "series",
                                type: new sap.extension.data.Numeric()
                            }).bindProperty("editable", {
                            ...
                            new sap.m.FlexBox("", {
                                ...
                                items: [
                                    ...
                                    new sap.extension.m.CheckBox("", {
                                        text: ibas.i18n.prop("bo_inventorytransferrequest_printed"),
                                        editable: false,
                                    }).bindProperty("bindingValue", {
                                        path: "printed",
                                        type: new sap.extension.data.YesNo()
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_inventorytransferrequest_postingdate"),
                            }),
                            new sap.extension.m.DatePicker("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                        ...
                        content: [
                            ...
                            this.tableInventoryTransferRequestLine = new sap.extension.table.DataTable("", {
                                ...
                                toolbar: new sap.m.Toolbar("", {
                                    content: [
                                        new sap.m.MenuButton("", {
                                            ...
                                            defaultAction(): void {
                                                that.fireViewEvents(that.addInventoryTransferRequestLineEvent, 1);
                                            }
                                        }),
                                        new sap.m.Button("", {
                                ...
                                columns: [
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                ...
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.chooseInventoryTransferRequestLineMaterialEvent, this.getBindingContext().getObject(), null, this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                                ...
                                                if (typeof data === "string") {
                                                    if (data?.indexOf("\n") > 0) {
                                                        sap.extension.tables.fillingCellsData(source, data,
                                                            (rowCount) => {
                                                                that.fireViewEvents(that.addInventoryTransferRequestLineEvent, rowCount);
                                                                return true;
                                                            },
                                                            (cell, value) => {
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.chooseInventoryTransferRequestLineWarehouseEvent, ibas.emDirection.OUT, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.chooseInventoryTransferRequestLineWarehouseEvent, ibas.emDirection.IN, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                                new ibas.Condition(materials.bo.Warehouse.PROPERTY_ACTIVATED_NAME, ibas.emConditionOperation.EQUAL, ibas.emYesNo.YES)
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("materials_document_inventoryquantity"),
