...
import { IMaterialInventoryChooseView } from "../../../bsapp/materialinventory/index";
export class MaterialInventoryChooseView extends ibas.BOChooseView implements IMaterialInventoryChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
            ...
            new sap.m.Button("", {
                ...
                press: function (): void {
                    that.fireViewEvents(that.chooseDataEvent,
                        // 获取表格选中的对象
                        utils.getTableSelecteds<bo.MaterialInventory>(that.table)
                    );
                }
            }),
            new sap.m.Button("", {
