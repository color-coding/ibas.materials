...
namespace materials {
    export namespace ui {
        export namespace m {
            /** 选择视图-业务伙伴物料目录 */
            export class BusinessPartnerMaterialCatalogChooseView extends ibas.BOChooseView implements app.IBusinessPartnerMaterialCatalogChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.BusinessPartnerMaterialCatalog;
                }
                /** 绘制视图 */
                draw(): any {
                    let that: this = this;
                    this.list = new sap.extension.m.List("", {
                        ...
                        items: {
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                dataInfo: {
                                    code: bo.BusinessPartnerMaterialCatalog.BUSINESS_OBJECT_CODE,
                                },
                                title: {
                                    path: "catalogCode",
                                ...
                                attributes: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_businesspartnermaterialcatalog_catalogname"),
                                        bindingValue: {
                                            path: "catalogName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_businesspartnermaterialcatalog_itemcode"),
                                        bindingValue: {
                                            path: "itemCode",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
