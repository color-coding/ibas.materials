    ...
    export namespace ui {
        export namespace m {
            ...
            export class InventoryTransferRequestViewView extends ibas.BOViewView implements app.IInventoryTransferRequestViewView {
                                                        ...
                                                        parts: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                formatter(data: ibas.emYesNo): string {
                                                                    return ibas.emYesNo.YES === data ? ibas.i18n.prop("bo_inventorytransferrequest_canceled") : "";
                                                                },
                                                            },
                                                        ]
                                                    }),
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewInventoryTransferRequestLine(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                                            new sap.ui.layout.form.SimpleForm("", {
                                                ...
                                                width: "auto",
                                                content: [
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_inventorytransferrequest_discounttotal") }),
                                                    new sap.extension.m.Text("", {
                                                    }).bindProperty("bindingValue", {
                                                        parts: [
                                                            {
                                                    ...
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_inventorytransferrequest_documenttaxtotal") }),
                                                    new sap.extension.m.Text("", {
                                                    }).bindProperty("bindingValue", {
                                                    ...
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_inventorytransferrequest_paidtotal") }),
                                                    new sap.extension.m.Text("", {
                                                    }).bindProperty("bindingValue", {
                                                        parts: [
                                                            {
                ...
                /** 编辑数据行（库存转储申请-行） */
                viewInventoryTransferRequestLine(data: bo.InventoryTransferRequestLine): void {
                    let that: this = this;
