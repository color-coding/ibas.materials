                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectApprovalStatus("", {
                                title: ibas.i18n.prop("bo_goodsissue_approvalstatus"),
                                enumValue: {
                                    path: "approvalStatus",
                                                            ...
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addGoodsIssueLineEvent, that.listGoodsIssueLine.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        attributes: [
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_goodsissueline_reference1"),
                                                                bindingValue: {
                                                                    path: "reference1",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_goodsissueline_reference2"),
                                                                bindingValue: {
                                                                    path: "reference2",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                ...
                editGoodsIssueLine(data: bo.GoodsIssueLine): void {
                    ...
                    if (!(editForm instanceof sap.m.Dialog)) {
                        editForm = new sap.m.Dialog(this.id + "_editform", {
                            title: ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_goodsissueline"), data.lineId),
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_goodsissueline_itemversion"),
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            ...
                                            if (datas instanceof Array && datas.length > 0) {
                                                ...
                                                editForm.setTitle(ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_goodsissueline"), datas[index].lineId));
                                            } else {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listGoodsIssueLine.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                that.fireViewEvents(that.removeGoodsIssueLineEvent, form.getModel().getData());
                                                if (datas.length === 1) {
                                                    // 无数据，退出
