...
export class MaterialReceiptSerialService extends BusinessObjectBase<MaterialReceiptSerialService> implements IMaterialReceiptSerialService {
    /** 业务对象编码 */
    ...
    /** 获取-行索引 */
    get index(): number {
        return this.getProperty<number>(MaterialReceiptSerialService.PROPERTY_INDEX_NAME);
    }
    /** 设置-行索引 */
    set index(value: number) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_INDEX_NAME, value);
    }
    ...
    /** 获取-行索引 */
    get lineId(): number {
        return this.getProperty<number>(MaterialReceiptSerialService.PROPERTY_LINEID_NAME);
    }
    /** 设置-行索引 */
    set lineId(value: number) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_LINEID_NAME, value);
    }
    /** 映射的属性名称-物料编号 */
    static PROPERTY_ITEMCODE_NAME: string = "ItemCode";
    /** 获取-物料编号 */
    get itemCode(): string {
        return this.getProperty<string>(MaterialReceiptSerialService.PROPERTY_ITEMCODE_NAME);
    }
    /** 设置-物料编号 */
    set itemCode(value: string) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_ITEMCODE_NAME, value);
    }
    ...
    get warehouse(): string {
        return this.getProperty<string>(MaterialReceiptSerialService.PROPERTY_WAREHOUSE_NAME);
    }
    /** 设置-仓库编号 */
    set warehouse(value: string) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_WAREHOUSE_NAME, value);
    }
    ...
    get direction(): emDirection {
        return this.getProperty<emDirection>(MaterialReceiptSerialService.PROPERTY_DIRECTION_NAME);
    }
    /** 设置-仓库编号 */
    set direction(value: emDirection) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_DIRECTION_NAME, value);
    }
    ...
    get needSerialQuantity(): number {
        return this.getProperty<number>(MaterialReceiptSerialService.PROPERTY_NEEDSERIALQUANTITY_NAME);
    }
    /** 设置-序列号总需求 */
    set needSerialQuantity(value: number) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_NEEDSERIALQUANTITY_NAME, value);
    }
    ...
    get selectedSerialQuantity(): number {
        return this.getProperty<number>(MaterialReceiptSerialService.PROPERTY_SELECTEDSERIALQUANTITY_NAME);
    }
    /** 设置-总序列 */
    set selectedSerialQuantity(value: number) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_SELECTEDSERIALQUANTITY_NAME, value);
    }
    ...
    /** 获取-数量 */
    get quantity(): number {
        return this.getProperty<number>(MaterialReceiptSerialService.PROPERTY_QUANTITY_NAME);
    }
    /** 设置-数量 */
    set quantity(value: number) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_QUANTITY_NAME, value);
    }
    /** 映射的属性名称-行-批次集合 */
    static PROPERTY_MATERIALSERIALJOURNALS_NAME: string = "MaterialReceiptSerialServiceJournals";
    /** 获取-行-序列号集合 */
    get materialSerialJournals(): MaterialReceiptSerialJournals {
        return this.getProperty<MaterialReceiptSerialJournals>
            (MaterialReceiptSerialService.PROPERTY_MATERIALSERIALJOURNALS_NAME);
    }
    /** 设置-行-序列号集合 */
    set materialSerialJournals(value: MaterialReceiptSerialJournals) {
        this.setProperty(MaterialReceiptSerialService.PROPERTY_MATERIALSERIALJOURNALS_NAME, value);
    }
    /** 初始化数据 */
    protected init(): void {
        this.materialSerialJournals = new MaterialReceiptSerialJournals(this);
    }
}

/** 序列日记账 集合 */
export class MaterialReceiptSerialJournals extends BusinessObjects<MaterialSerialJournal, MaterialReceiptSerialService>
    implements IMaterialReceiptSerialJournals {
    /** 创建并添加子项 */
    ...
    /** 创建并添加子项 */
    createSerialJournal(data: MaterialSerialJournal): MaterialSerialJournal {
