...
import {
    IMaterialInventoryJournal,
    BO_CODE_MATERIALJOURNAL,
} from "../../api/index";

/** 仓库日记账 */
export class MaterialInventoryJournal extends BOSimple<MaterialInventoryJournal> implements IMaterialInventoryJournal {
    ...
    get direction(): emDirection {
        return this.getProperty<emDirection>(MaterialInventoryJournal.PROPERTY_DIRECTION_NAME);
    }
    /** 设置-方向 */
    ...
    /** 初始化数据 */
    protected init(): void {
        this.objectCode = config.applyVariables(MaterialInventoryJournal.BUSINESS_OBJECT_CODE);
    }
}
