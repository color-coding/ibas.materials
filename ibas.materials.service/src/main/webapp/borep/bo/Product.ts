    ...
    export namespace bo {
        export class Product extends ibas.BOMasterData<Product> implements IProduct {
            ...
            get versionManagement(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Product.PROPERTY_VERSIONMANAGEMENT_NAME);
            }
            /** 设置-版本管理 */
            set versionManagement(value: ibas.emYesNo) {
                this.setProperty(Product.PROPERTY_VERSIONMANAGEMENT_NAME, value);
            }
            /** 映射的属性名称-采购税收组 */
            ...
            get keyComponent(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Product.PROPERTY_KEYCOMPONENT_NAME);
            }
            /** 设置-关键件 */
            set keyComponent(value: ibas.emYesNo) {
                this.setProperty(Product.PROPERTY_KEYCOMPONENT_NAME, value);
            }
