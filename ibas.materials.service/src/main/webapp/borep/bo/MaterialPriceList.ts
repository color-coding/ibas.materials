...
import {
    ...
    IMaterialPriceItem,
    IMaterialPriceItems,
    BO_CODE_MATERIALPRICELIST,
} from "../../api/index";
export class MaterialPriceList extends BOSimple<MaterialPriceList> implements IMaterialPriceList {
...
export class MaterialPriceItem extends BOSimpleLine<MaterialPriceItem> implements IMaterialPriceItem {
    /** 构造函数 */
    constructor() {
        super();
    }
