...
namespace materials {
    export namespace bo {
        /** 库存发货 */
        export class GoodsIssue extends ibas.BODocument<GoodsIssue> implements IGoodsIssue {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(GoodsIssue.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get canceled(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssue.PROPERTY_CANCELED_NAME);
            }
            /** 设置-取消 */
            ...
            get status(): ibas.emBOStatus {
                return this.getProperty<ibas.emBOStatus>(GoodsIssue.PROPERTY_STATUS_NAME);
            }
            /** 设置-状态 */
            ...
            get approvalStatus(): ibas.emApprovalStatus {
                return this.getProperty<ibas.emApprovalStatus>(GoodsIssue.PROPERTY_APPROVALSTATUS_NAME);
            }
            /** 设置-审批状态 */
            ...
            get documentStatus(): ibas.emDocumentStatus {
                return this.getProperty<ibas.emDocumentStatus>(GoodsIssue.PROPERTY_DOCUMENTSTATUS_NAME);
            }
            /** 设置-单据状态 */
            ...
            get referenced(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssue.PROPERTY_REFERENCED_NAME);
            }
            /** 设置-已引用 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssue.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(GoodsIssue.PROPERTY_PRINTED_NAME, value);
            }
            ...
            get orderType(): string {
                return this.getProperty<string>(GoodsIssue.PROPERTY_ORDERTYPE_NAME);
            }
            /** 设置-单据类型 */
            ...
            reset(): void {
                super.reset();
                this.documentStatus = ibas.emDocumentStatus.RELEASED;
                this.goodsIssueLines.forEach(c => c.lineStatus = ibas.emDocumentStatus.RELEASED);
            }
        ...
        /** 库存发货-行 集合 */
        export class GoodsIssueLines extends ibas.BusinessObjects<GoodsIssueLine, GoodsIssue> implements IGoodsIssueLines {
            /** 创建并添加子项 */
        ...
        /** 库存发货-行 */
        export class GoodsIssueLine extends ibas.BODocumentLine<GoodsIssueLine> implements IGoodsIssueLine {
            ...
            /** 获取-取消 */
            get canceled(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssueLine.PROPERTY_CANCELED_NAME);
            }
            /** 设置-取消 */
            set canceled(value: ibas.emYesNo) {
            ...
            /** 获取-状态 */
            get status(): ibas.emBOStatus {
                return this.getProperty<ibas.emBOStatus>(GoodsIssueLine.PROPERTY_STATUS_NAME);
            }
            /** 设置-状态 */
            set status(value: ibas.emBOStatus) {
            ...
            get lineStatus(): ibas.emDocumentStatus {
                return this.getProperty<ibas.emDocumentStatus>(GoodsIssueLine.PROPERTY_LINESTATUS_NAME);
            }
            /** 设置-单据状态 */
            ...
            /** 获取-已引用 */
            get referenced(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssueLine.PROPERTY_REFERENCED_NAME);
            }
            /** 设置-已引用 */
            set referenced(value: ibas.emYesNo) {
            ...
            /** 获取-物料标识 */
            get itemSign(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_ITEMSIGN_NAME);
            }
            /** 设置-物料标识 */
            set itemSign(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_ITEMSIGN_NAME, value);
            }
            ...
            get itemVersion(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_ITEMVERSION_NAME);
            }
            /** 设置-物料版本 */
            set itemVersion(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_ITEMVERSION_NAME, value);
            }
            ...
            get serialManagement(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssueLine.PROPERTY_SERIALMANAGEMENT_NAME);
            }
            /** 设置-序号管理 */
            ...
            get batchManagement(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(GoodsIssueLine.PROPERTY_BATCHMANAGEMENT_NAME);
            }
            /** 设置-批号管理 */
            ...
            get distributionRule1(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE1_NAME);
            }
            /** 设置-成本中心1 */
            set distributionRule1(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE1_NAME, value);
            }
            ...
            get distributionRule2(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE2_NAME);
            }
            /** 设置-成本中心2 */
            set distributionRule2(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE2_NAME, value);
            }
            ...
            get distributionRule3(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE3_NAME);
            }
            /** 设置-成本中心3 */
            set distributionRule3(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE3_NAME, value);
            }
            ...
            get distributionRule4(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE4_NAME);
            }
            /** 设置-成本中心4 */
            set distributionRule4(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE4_NAME, value);
            }
            ...
            get distributionRule5(): string {
                return this.getProperty<string>(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE5_NAME);
            }
            /** 设置-成本中心5 */
            set distributionRule5(value: string) {
                this.setProperty(GoodsIssueLine.PROPERTY_DISTRIBUTIONRULE5_NAME, value);
            }
            ...
            get materialBatches(): MaterialBatchItems {
                return this.getProperty<MaterialBatchItems>(GoodsIssueLine.PROPERTY_MATERIALBATCHES_NAME);
            }
            /** 设置-物料批次集合 */
            ...
            get materialSerials(): MaterialSerialItems {
                return this.getProperty<MaterialSerialItems>(GoodsIssueLine.PROPERTY_MATERIALSERIALS_NAME);
            }
            /** 设置-物料序列集合 */
