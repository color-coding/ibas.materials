...
namespace materials {
    export namespace bo {
        ...
        export class InventoryTransfer extends ibas.BODocument<InventoryTransfer> implements IInventoryTransfer {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(InventoryTransfer.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(InventoryTransfer.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(InventoryTransfer.PROPERTY_PRINTED_NAME, value);
            }
            ...
            baseDocument(data: IInventoryTransferRequest): void {
                ...
                // 赋值行
                for (let item of data.inventoryTransferRequestLines) {
                    if (item.closedQuantity >= item.quantity) {
                        continue;
                    }
                    let nItem: InventoryTransferLine = this.inventoryTransferLines.create();
                    nItem.baseDocument(item);
                }

            }
        }
        const CONFIG_ITEM_ONLY_SET_EXISTING_USER_FIELDS_VALUE: string = "onlySetExistingUserFields";
        /** 库存转储-行 集合 */
        export class InventoryTransferLines extends ibas.BusinessObjects<InventoryTransferLine, InventoryTransfer> implements IInventoryTransferLines {
            ...
            protected onParentPropertyChanged(name: string): void {
                ...
                if (!this.parent.isLoading) {
                    if (ibas.strings.equalsIgnoreCase(name, InventoryTransfer.PROPERTY_DOCUMENTRATE_NAME)) {
                    ...
                    } else if (ibas.strings.equalsIgnoreCase(name, InventoryTransfer.PROPERTY_DOCUMENTCURRENCY_NAME)) {
        ...
        export class InventoryTransferLine extends ibas.BODocumentLine<InventoryTransferLine> implements IInventoryTransferLine {
            ...
            get distributionRule1(): string {
                return this.getProperty<string>(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE1_NAME);
            }
            /** 设置-成本中心1 */
            set distributionRule1(value: string) {
                this.setProperty(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE1_NAME, value);
            }
            ...
            get distributionRule2(): string {
                return this.getProperty<string>(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE2_NAME);
            }
            /** 设置-成本中心2 */
            set distributionRule2(value: string) {
                this.setProperty(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE2_NAME, value);
            }
            ...
            get distributionRule3(): string {
                return this.getProperty<string>(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE3_NAME);
            }
            /** 设置-成本中心3 */
            set distributionRule3(value: string) {
                this.setProperty(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE3_NAME, value);
            }
            ...
            get distributionRule4(): string {
                return this.getProperty<string>(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE4_NAME);
            }
            /** 设置-成本中心4 */
            set distributionRule4(value: string) {
                this.setProperty(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE4_NAME, value);
            }
            ...
            get distributionRule5(): string {
                return this.getProperty<string>(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE5_NAME);
            }
            /** 设置-成本中心5 */
            set distributionRule5(value: string) {
                this.setProperty(InventoryTransferLine.PROPERTY_DISTRIBUTIONRULE5_NAME, value);
            }
            ...
            baseDocument(data: IInventoryTransferRequestLine): void {
                this.baseDocumentType = data.objectCode;
                this.baseDocumentEntry = data.docEntry;
                this.baseDocumentLineId = data.lineId;
                this.distributionRule1 = data.distributionRule1;
                this.distributionRule2 = data.distributionRule2;
