...
namespace materials {
    export namespace bo {
        /** 物料序列记录 */
        export class MaterialSerialJournal extends ibas.BOSimple<MaterialSerialJournal> implements IMaterialSerialJournal {
            ...
            get direction(): ibas.emDirection {
                return this.getProperty<ibas.emDirection>(MaterialSerialJournal.PROPERTY_DIRECTION_NAME);
            }
            /** 设置-方向 */
            ...
            /** 初始化数据 */
            protected init(): void {
                this.objectCode = ibas.config.applyVariables(MaterialSerialJournal.BUSINESS_OBJECT_CODE);
            }
        }
    }
}
