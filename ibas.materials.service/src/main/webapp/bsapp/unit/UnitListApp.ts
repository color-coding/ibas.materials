...
namespace materials {
    export namespace app {
        /** 列表应用-计量单位 */
        export class UnitListApp extends ibas.BOListApplication<IUnitListView, bo.Unit> {
            /** 应用标识 */
            static APPLICATION_ID: string = "30a64956-66db-4eab-9b2d-c87b4dd6152e";
            /** 应用名称 */
            static APPLICATION_NAME: string = "materials_app_unit_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Unit.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = UnitListApp.APPLICATION_ID;
                this.name = UnitListApp.APPLICATION_NAME;
                this.boCode = UnitListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.Unit | bo.Unit[]): void {
                let beDeleteds: ibas.IList<bo.Unit> = ibas.arrays.create(data);
                // 没有选择删除的对象
