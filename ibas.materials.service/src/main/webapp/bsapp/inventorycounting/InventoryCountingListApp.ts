...
namespace materials {
    export namespace app {
        /** 列表应用-库存盘点 */
        export class InventoryCountingListApp extends ibas.BOListApplication<IInventoryCountingListView, bo.InventoryCounting> {
            /** 应用标识 */
            static APPLICATION_ID: string = "5c2e3bf7-b09a-4ad8-a3af-a05ef6fd9fee";
            /** 应用名称 */
            static APPLICATION_NAME: string = "materials_app_inventorycounting_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.InventoryCounting.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = InventoryCountingListApp.APPLICATION_ID;
                this.name = InventoryCountingListApp.APPLICATION_NAME;
                this.boCode = InventoryCountingListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.InventoryCounting | bo.InventoryCounting[]): void {
                let beDeleteds: ibas.IList<bo.InventoryCounting> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-库存盘点 */
        export interface IInventoryCountingListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
