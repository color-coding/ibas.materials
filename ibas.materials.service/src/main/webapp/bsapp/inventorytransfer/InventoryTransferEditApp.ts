...
namespace materials {
    export namespace app {
        ...
        export class InventoryTransferEditApp extends ibas.BOEditService<IInventoryTransferEditView, bo.InventoryTransfer> {
            ...
            /** 选择库存转储订单行仓库事件 */
            private chooseInventoryTransferLineWarehouse(caller: bo.InventoryTransferLine, direction: ibas.emDirection, filterConditions?: ibas.ICondition[]): void {
                ...
                ibas.servicesManager.runApplicationService<materials.app.IMaterialQuantitiesContract>({
                    proxy: new materials.app.MaterialQuantitiesServiceProxy({
                        ...
                        applyQuantity: (quantity, uom, warehouse) => {
                            ...
                            caller.uom = uom;
                            caller.fromWarehouse = warehouse;
                        }
                    })
                });
            }
