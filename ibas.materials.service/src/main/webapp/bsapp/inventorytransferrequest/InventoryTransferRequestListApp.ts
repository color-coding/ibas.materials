...
namespace materials {
    export namespace app {
        /** 列表应用-库存转储申请 */
        export class InventoryTransferRequestListApp extends ibas.BOListApplication<IInventoryTransferRequestListView, bo.InventoryTransferRequest> {
            /** 应用标识 */
            static APPLICATION_ID: string = "8141eb62-fe61-4c39-95ec-ef564d1655c0";
            /** 应用名称 */
            static APPLICATION_NAME: string = "materials_app_inventorytransferrequest_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.InventoryTransferRequest.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = InventoryTransferRequestListApp.APPLICATION_ID;
                this.name = InventoryTransferRequestListApp.APPLICATION_NAME;
                this.boCode = InventoryTransferRequestListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.InventoryTransferRequest): void {
                ...
                let app: InventoryTransferRequestViewApp = new InventoryTransferRequestViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.InventoryTransferRequest | bo.InventoryTransferRequest[]): void {
                let beDeleteds: ibas.IList<bo.InventoryTransferRequest> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-库存转储申请 */
        export interface IInventoryTransferRequestListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
