...
@XmlType(name = MaterialSpecialPrice.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = MaterialSpecialPrice.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = MaterialSpecialPrice.BUSINESS_OBJECT_CODE)
public class MaterialSpecialPrice extends BusinessObject<MaterialSpecialPrice> implements IMaterialSpecialPrice {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 1354581876415694085L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = MaterialSpecialPrice.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_OMSP";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_MM_SPECIALPRICE";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "MaterialSpecialPrice";
