 ...
 * 物料 - 收货服务  生成一张日记账
 */
public class MaterialReceiptService  extends BusinessLogic<IMaterialReceiptContract,IMaterialJournal>{
    @Override
    protected IMaterialJournal fetchBeAffected(IMaterialReceiptContract contract) {
        try{
