...
public class MaterialsExtendedSetting extends BusinessObject<MaterialsExtendedSetting>
	 ...
	 * 扩展项目 属性
	 */
	@DbField(name = "Element", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 目标类型 属性
	 */
	@DbField(name = "TargetCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 目标键值 属性
	 */
	@DbField(name = "TargetKeys", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 启用的 属性
	 */
	@DbField(name = "Enabled", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
