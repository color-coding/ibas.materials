...
public class MaterialPriceItem extends BusinessObject<MaterialPriceItem> implements IMaterialPriceItem {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 4042708276547365713L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = MaterialPriceItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_MPL1";
	 ...
	 * 单位 属性
	 */
	@DbField(name = "UOM", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 对象编号 属性
	 */
	@DbField(name = "ObjectKey", type = DataType.NUMERIC, table = DB_TABLE_NAME, primaryKey = true, uniqueKey = true)
	...
	protected void initialize() {
		...
		this.setUOM(Strings.VALUE_EMPTY);
	}
