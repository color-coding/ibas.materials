...
@XmlType(name = InventoryTransferRequest.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = InventoryTransferRequest.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = InventoryTransferRequest.BUSINESS_OBJECT_CODE)
public class InventoryTransferRequest extends BusinessObject<InventoryTransferRequest>
		implements IInventoryTransferRequest, IDataOwnership, IApprovalData, IBOTagCanceled, IPeriodData, IProjectData,
		IBOSeriesKey, IBOUserFields, IBusinessLogicsHost {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 7005537051568850938L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = InventoryTransferRequest.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_OWTQ";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "InventoryTransferRequest";
	 ...
	 * 属性名称-库存转储请求-行
	 */
	private static final String PROPERTY_INVENTORYTRANSFERREQUESTLINES_NAME = "InventoryTransferRequestLines";

	/**
	 * 库存转储请求-行的集合属性
	 * 
	 */
	public static final IPropertyInfo<IInventoryTransferRequestLines> PROPERTY_INVENTORYTRANSFERREQUESTLINES = registerProperty(
			PROPERTY_INVENTORYTRANSFERREQUESTLINES_NAME, IInventoryTransferRequestLines.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_INVENTORYTRANSFERREQUESTLINES_NAME)
	@XmlElement(name = InventoryTransferRequestLine.BUSINESS_OBJECT_NAME, type = InventoryTransferRequestLine.class)
	public final IInventoryTransferRequestLines getInventoryTransferRequestLines() {
		return this.getProperty(PROPERTY_INVENTORYTRANSFERREQUESTLINES);
	}
	 ...
	 * @param value 值
	 */
	public final void setInventoryTransferRequestLines(IInventoryTransferRequestLines value) {
		this.setProperty(PROPERTY_INVENTORYTRANSFERREQUESTLINES, value);
	}
	...
	protected void initialize() {
		...
		this.setInventoryTransferRequestLines(new InventoryTransferRequestLines(this));
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] { // 注册的业务规则
				new BusinessRuleRequiredElements(PROPERTY_INVENTORYTRANSFERREQUESTLINES), // 要求有元素
				new BusinessRuleDocumentStatus(PROPERTY_DOCUMENTSTATUS, PROPERTY_INVENTORYTRANSFERREQUESTLINES,
						InventoryTransferRequestLine.PROPERTY_LINESTATUS), // 使用集合元素状态
				new BusinessRuleSumElements(PROPERTY_DOCUMENTTOTAL, PROPERTY_INVENTORYTRANSFERREQUESTLINES,
						InventoryTransferRequestLine.PROPERTY_LINETOTAL), // 计算单据总计
		...
		return new IBusinessLogicContract[] {
				...
				new IBranchCheckContract() {
					...
					public String getIdentifiers() {
						return InventoryTransferRequest.this.toString();
					}

					@Override
					public String getBranch() {
						return InventoryTransferRequest.this.getBranch();
					}
				}
