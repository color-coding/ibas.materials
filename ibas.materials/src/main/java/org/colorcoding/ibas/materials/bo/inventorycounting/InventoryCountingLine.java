...
public class InventoryCountingLine extends BusinessObject<InventoryCountingLine>
	 ...
	 * 库存数量 属性
	 */
	@DbField(name = "InvtQty", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 盘点数量 属性
	 */
	@DbField(name = "CountQty", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 差额 属性
	 */
	@DbField(name = "Difference", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 已盘点 属性
	 */
	@DbField(name = "Counted", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 冻结物料 属性
	 */
	@DbField(name = "Freeze", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
