...
@XmlType(name = PickingListNumber.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PickingListNumber extends BusinessObject<PickingListNumber> implements IPickingListNumber, IBOUserFields {
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PickingListNumber.class;
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PickingListNumber";
