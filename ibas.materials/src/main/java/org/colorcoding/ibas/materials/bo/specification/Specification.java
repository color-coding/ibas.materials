...
@BusinessObjectUnit(code = Specification.BUSINESS_OBJECT_CODE)
public class Specification extends BusinessObject<Specification>
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_OSPC";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_MM_SPEC";
	 ...
	 * 目标 属性
	 */
	@DbField(name = "Target", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
