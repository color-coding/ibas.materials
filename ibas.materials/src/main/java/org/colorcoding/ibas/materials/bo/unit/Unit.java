...
@XmlType(name = Unit.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Unit.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = Unit.BUSINESS_OBJECT_CODE)
public class Unit extends BusinessObject<Unit> implements IUnit {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -5019579028470735526L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Unit.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_OUNT";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_MM_UNIT";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Unit";
	 ...
	 * 属性名称-符号
	 */
	private static final String PROPERTY_SYMBOL_NAME = "Symbol";

	/**
	 * 符号 属性
	 */
	@DbField(name = "Symbol", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_SYMBOL = registerProperty(PROPERTY_SYMBOL_NAME, String.class,
			MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_SYMBOL_NAME)
	public final String getSymbol() {
		return this.getProperty(PROPERTY_SYMBOL);
	}
	...
	public final void setSymbol(String value) {
		this.setProperty(PROPERTY_SYMBOL, value);
	}
	 ...
	 * 小数位数 属性
	 */
	@DbField(name = "DecmPlaces", type = DataType.NUMERIC, table = DB_TABLE_NAME)
