 ...
 * 库存发货-序列 集合
 */
@XmlType(name = GoodsIssueLineMaterialSerialJournals.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlSeeAlso({ MaterialSerialJournal.class })
public class GoodsIssueLineMaterialSerialJournals extends BusinessObjects<IMaterialSerialJournal,IGoodsIssueLine> implements IGoodsIssueLineMaterialSerialJournals {
    /**
     * 业务对象名称
     */
    public static final String BUSINESS_OBJECT_NAME = "GoodsIssueLineMaterialSerialJournals";
    ...
    public GoodsIssueLineMaterialSerialJournals(){super();}

    /**
     * 构造方法
     * @param parent 父项对象
     */
    public GoodsIssueLineMaterialSerialJournals(IGoodsIssueLine parent) {
        super(parent);
    }
