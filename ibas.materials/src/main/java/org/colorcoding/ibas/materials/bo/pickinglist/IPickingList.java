 ...
 * 拣配清单 接口
 */
public interface IPickingList extends IBOSimple {
	 ...
	 * @param value 值
	 */
	void setPickingDate(DateTime value);
	 ...
	 * @return 值
	 */
	IPickingListLines getPickingListLines();
	 ...
	 * @param value 值
	 */
	void setPickingListLines(IPickingListLines value);
