 ...
 * 
 */
public interface IMaterialSpecification extends IBOSimple {
	 ...
	 * @return 值
	 */
	IMaterialSpecificationItems getMaterialSpecificationItems();
	 ...
	 * @param value 值
	 */
	void setMaterialSpecificationItems(IMaterialSpecificationItems value);
