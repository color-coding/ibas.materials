...
public class UnitRate extends BusinessObject<UnitRate> implements IUnitRate {
	 ...
	 * 源 属性
	 */
	@DbField(name = "Source", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 条件 属性
	 */
	@DbField(name = "Condition", type = DataType.MEMO, table = DB_TABLE_NAME, uniqueKey = true)
