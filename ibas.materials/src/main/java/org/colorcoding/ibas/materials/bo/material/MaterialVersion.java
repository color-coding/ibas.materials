...
@XmlType(name = MaterialVersion.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = MaterialVersion.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = MaterialVersion.BUSINESS_OBJECT_CODE)
public class MaterialVersion extends BusinessObject<MaterialVersion> implements IMaterialVersion {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 617028942386803088L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = MaterialVersion.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_IMVER";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_MM_MATERIALVERSION";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "MaterialVersion";
