...
public class MaterialSubstitute extends BusinessObject<MaterialSubstitute>
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -8967818201379680911L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = MaterialSubstitute.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_IMSUB";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_MM_SUBSTITUTE";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "MaterialSubstitute";
	 ...
	 * 位置 属性
	 */
	@DbField(name = "Position", type = DataType.NUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-替代物料
	 */
	private static final String PROPERTY_SUBSTITUTE_NAME = "Substitute";

	/**
	 * 替代物料 属性
	 */
	@DbField(name = "Substitute", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_SUBSTITUTE_NAME)
	public final String getSubstitute() {
		return this.getProperty(PROPERTY_SUBSTITUTE);
	}
	 ...
	 * @param value 值
	 */
	public final void setSubstitute(String value) {
		this.setProperty(PROPERTY_SUBSTITUTE, value);
	}
