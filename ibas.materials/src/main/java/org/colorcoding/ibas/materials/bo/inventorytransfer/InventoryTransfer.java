...
public class InventoryTransfer extends BusinessObject<InventoryTransfer>
		implements IInventoryTransfer, IDataOwnership, IApprovalData, IBOTagCanceled, IPeriodData, IProjectData,
		IBOSeriesKey, IBOUserFields, IBusinessLogicsHost, IDocumentPrintedOperator {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 5623635178919959067L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_OWTR";
	...
	*/
	 ...
	 * 
	 */
	public static final IPropertyInfo<IInventoryTransferLines> PROPERTY_INVENTORYTRANSFERLINES = registerProperty(
			PROPERTY_INVENTORYTRANSFERLINES_NAME, IInventoryTransferLines.class, MY_CLASS);
				...
				new IJournalEntryCreationContract() {
					...
					public JournalEntryContent[] getContents() {
						...
						for (IInventoryTransferLine line : InventoryTransfer.this.getInventoryTransferLines()) {
							...
							// 库存科目（目的仓：增加）
							// 使用默认仓库（InventoryTransferLine.Warehouse = 目的仓）
