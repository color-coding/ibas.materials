...
@XmlType(name = GoodsIssue.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
...
public class GoodsIssue extends BusinessObject<GoodsIssue>
		implements IGoodsIssue, IDataOwnership, IApprovalData, IBOTagCanceled, IPeriodData, IProjectData, IBOSeriesKey,
		IBOUserFields, IBusinessLogicsHost, IDocumentPrintedOperator {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -8358306718355429308L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_MM_OIGE";
	...
	*/
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] {
				...
				new BusinessRuleSumElements(PROPERTY_DOCUMENTTOTAL, PROPERTY_GOODSISSUELINES,
						GoodsIssueLine.PROPERTY_LINETOTAL), // 计算单据总计
		...
		return new IBusinessLogicContract[] {
				...
				new IJournalEntryCreationContract() {
					...
					public boolean isOffsetting() {
						...
						if (GoodsIssue.this instanceof IBOTagDeleted) {
							IBOTagDeleted boTag = (IBOTagDeleted) GoodsIssue.this;
