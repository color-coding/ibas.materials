...
@BusinessObjectUnit(code = MaterialPriceList.BUSINESS_OBJECT_CODE)
public class MaterialPriceList extends BusinessObject<MaterialPriceList>
	 ...
	 * 基于的清单 属性
	 */
	@DbField(name = "BasedOn", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 系数 属性
	 */
	@DbField(name = "Factor", type = DataType.DECIMAL, editType = EditType.PERCENTAGE, table = DB_TABLE_NAME)
	 ...
	 * 含税 属性
	 */
	@DbField(name = "Taxed", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 底价清单 属性
	 */
	@DbField(name = "FloorList", type = DataType.NUMERIC, table = DB_TABLE_NAME)
