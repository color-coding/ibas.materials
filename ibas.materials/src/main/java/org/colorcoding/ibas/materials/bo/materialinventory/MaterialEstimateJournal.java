...
public class MaterialEstimateJournal extends BusinessObject<MaterialEstimateJournal>
	 ...
	 * 预估类型 属性
	 */
	@DbField(name = "Estimate", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] { // 注册的业务规则
				...
				new BusinessRuleMinValue<BigDecimal>(Decimals.VALUE_ZERO, PROPERTY_RESERVEDQUANTITY), // 不能低于0
				/*
				 * // 预留数量不能大于订购数量
				 * 
				 * new BusinessRuleMaxProperty<BigDecimal>(PROPERTY_QUANTITY,
