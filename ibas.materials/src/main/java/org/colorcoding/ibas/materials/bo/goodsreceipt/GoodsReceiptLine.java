...
public class GoodsReceiptLine extends BusinessObject<GoodsReceiptLine>
	...
	public void check() throws BusinessRuleException {
		...
		if (Decimals.VALUE_ZERO.compareTo(this.getInventoryQuantity()) >= 0) {
			throw new BusinessRuleException(I18N.prop("msg_mm_document_material_quantity_invalid", this.toString()));
		}
		// 批次检查
		...
		return new IBusinessLogicContract[] {
				...
				new IMaterialReceiptContract() {
					...
					public boolean isOffsetting() {
						...
						if (GoodsReceiptLine.this.parent instanceof IApprovalData) {
							IApprovalData apData = (IApprovalData) GoodsReceiptLine.this.parent;
