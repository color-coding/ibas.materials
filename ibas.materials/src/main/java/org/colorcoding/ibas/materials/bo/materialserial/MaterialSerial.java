...
@XmlType(name = MaterialSerial.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = MaterialSerial.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@BOCode(MaterialSerial.BUSINESS_OBJECT_CODE)
public class MaterialSerial extends BusinessObject<MaterialSerial> implements IMaterialSerial {
