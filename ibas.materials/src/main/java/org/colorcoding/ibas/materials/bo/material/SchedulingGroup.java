...
@XmlType(name = SchedulingGroup.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = SchedulingGroup.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = SchedulingGroup.BUSINESS_OBJECT_CODE)
public class SchedulingGroup extends BusinessObject<SchedulingGroup> implements ISchedulingGroup {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -8598310500437124050L;

	/**
	* 当前类型
	*/
	private static final Class<?> MY_CLASS = SchedulingGroup.class;

	/**
	* 数据库表
	*/
	public static final String DB_TABLE_NAME = "${Company}_MM_OSDG";

	/**
	* 业务对象编码
	*/
	public static final String BUSINESS_OBJECT_CODE = "${Company}_MM_SCHEDULINGGROUP";

	/**
	* 业务对象名称
	*/
	public static final String BUSINESS_OBJECT_NAME = "SchedulingGroup";
