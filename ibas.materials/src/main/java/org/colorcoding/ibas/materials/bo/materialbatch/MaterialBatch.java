...
public class MaterialBatch extends BusinessObject<MaterialBatch> implements IMaterialBatch, IBOUserFields, ICheckRules {
	 ...
	 * 批次编码 属性
	 */
	@DbField(name = "BatchCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 预留数量 属性
	 */
	@DbField(name = "ReserveQty", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
