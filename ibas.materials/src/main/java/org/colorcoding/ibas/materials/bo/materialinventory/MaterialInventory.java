...
public class MaterialInventory extends BusinessObject<MaterialInventory> implements IMaterialInventory, ICheckRules {
	 ...
	 * 冻结的 属性
	 */
	@DbField(name = "Frozen", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 库存 属性
	 */
	@DbField(name = "OnHand", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 已承诺 属性
	 */
	@DbField(name = "OnCommited", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 已订购 属性
	 */
	@DbField(name = "OnOrdered", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 已预留 属性
	 */
	@DbField(name = "OnReserved", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
