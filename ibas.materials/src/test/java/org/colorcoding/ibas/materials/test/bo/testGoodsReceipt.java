...
public class testGoodsReceipt extends TestCase {
    ...
    */
    public void testBasicItems() throws Exception {
        ...
        IMaterialSerialJournal goodsreceiptlineSerial = goodsreceiptline.getGoodsReceiptMaterialSerialJournals().create();
    ...
    public void testLogic() throws Exception{
        ...
        MaterialInventoryJournal materialInventoryJournal = (MaterialInventoryJournal)operationResult.getResultObjects().firstOrDefault();
        assertEquals(operationResult.getMessage(), operationResult.getResultCode(), 0);
