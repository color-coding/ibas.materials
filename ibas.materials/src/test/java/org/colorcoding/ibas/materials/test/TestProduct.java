...
public class TestProduct extends TestCase {
	...
	public void testFetchProduct() throws Exception {
		...
		condition.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		...
		condition1.setAlias(Product.CONDITION_ALIAS_WAREHOUSE);
		condition1.setValue(whsCode2);
		condition1.setOperation(ConditionOperation.EQUAL);
		condition1.setRelationship(ConditionRelationship.AND);
		condition1 = criteria1.getConditions().create();
		condition1.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		...
		condition2.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		condition2.setValue(baseOnList);
		condition2.setOperation(ConditionOperation.EQUAL);
		condition2.setRelationship(ConditionRelationship.AND);
		condition2 = criteria2.getConditions().create();
		condition2.setAlias(Product.CONDITION_ALIAS_WAREHOUSE);
		...
		condition3 = criteria3.getConditions().create();
		condition3.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		condition3.setValue(baseOnList);
		condition3.setOperation(ConditionOperation.EQUAL);
		condition3.setRelationship(ConditionRelationship.AND);
		condition3 = criteria3.getConditions().create();
		condition3.setAlias(Product.CONDITION_ALIAS_WAREHOUSE);
		...
		assertEquals(opRstProduct.getMessage(), 0, opRstProduct.getResultCode());
		assertEquals("库存查询错误", 1100, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode1))
				.getOnHand().intValue());
		assertEquals("价格清单查询错误", 144, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode1))
				.getPrice().intValue());
		assertEquals("库存查询错误", 2200, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode2))
				.getOnHand().intValue());
		assertEquals("价格清单查询错误", 1500, opRstProduct.getResultObjects()
				.firstOrDefault(c -> c.getCode().equals(itemCode2)).getPrice().intValue());
		...
		condition4.setAlias(Product.CONDITION_ALIAS_WAREHOUSE);
		condition4.setValue(whsCode1);
		condition4.setOperation(ConditionOperation.EQUAL);
		condition4.setRelationship(ConditionRelationship.AND);
		condition4 = criteria4.getConditions().create();
		condition4.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		condition4.setValue(baseOnList1);
		condition4.setOperation(ConditionOperation.EQUAL);
		condition4.setRelationship(ConditionRelationship.AND);
		opRstProduct = boRepository.fetchProduct(criteria4);
		assertEquals(opRstProduct.getMessage(), 0, opRstProduct.getResultCode());
		assertEquals("库存查询错误", null,
				opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode1)));
		assertEquals("价格清单查询错误", 1000, opRstProduct.getResultObjects()
				.firstOrDefault(c -> c.getCode().equals(itemCode2)).getPrice().intValue());
		assertEquals("库存查询错误", 200, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode2))
				.getOnHand().intValue());
		assertEquals("价格清单查询错误", 1000, opRstProduct.getResultObjects()
				.firstOrDefault(c -> c.getCode().equals(itemCode3)).getPrice().intValue());
		assertEquals("库存查询错误", 300, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode3))
				.getOnHand().intValue());
		...
		condition5.setAlias(Product.CONDITION_ALIAS_WAREHOUSE);
		...
		condition5 = criteria5.getConditions().create();
		condition5.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		...
		assertEquals("价格清单查询错误", 1000, opRstProduct.getResultObjects()
				.firstOrDefault(c -> c.getCode().equals(itemCode2)).getPrice().intValue());
		assertEquals("库存查询错误", 20200, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode2))
				.getOnHand().intValue());
		assertEquals("价格清单查询错误", 1000, opRstProduct.getResultObjects()
				.firstOrDefault(c -> c.getCode().equals(itemCode3)).getPrice().intValue());
		assertEquals("库存查询错误", 30300, opRstProduct.getResultObjects().firstOrDefault(c -> c.getCode().equals(itemCode3))
				.getOnHand().intValue());
		...
		condition6.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		...
		condition7.setAlias(Product.CONDITION_ALIAS_PRICELIST);
		...
		// condition8.setAlias(Product.CONDITION_ALIAS_PRICELIST);
	...
	public void testFetchMaterialPrice() throws Exception {
		...
		// region 测试查询
		IOperationResult<IMaterialPrice> opRstMaterialPrice = null;
		...
		assertEquals(opRstMaterialPrice.getMessage(), 0, opRstMaterialPrice.getResultCode());
		assertEquals("价格清单查询错误", 144, opRstMaterialPrice.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode1)).getPrice().intValue());
		assertEquals("价格清单查询错误", 200, opRstMaterialPrice.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode2)).getPrice().intValue());
		assertEquals("价格清单查询错误", 0, opRstMaterialPrice.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode3)).getPrice().intValue());
		assertEquals("价格清单查询错误", 444, opRstMaterialPrice.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode4)).getPrice().intValue());
	...
	public void testFetchMaterialQuantity() throws Exception {
		...
		// region 测试查询
		IOperationResult<IMaterialQuantity> opRstMaterialQuantity = null;
		// region 一个仓库的所有库存
		ICriteria criteria = new Criteria();
		ICondition condition = criteria.getConditions().create();
		condition.setAlias(Material.PROPERTY_CODE.getName());
		...
		condition1.setOperation(ConditionOperation.EQUAL);
		condition1 = criteria1.getConditions().create();
		condition1.setAlias(MaterialQuantity.CONDITION_ALIAS_WAREHOUSE);
		condition1.setValue(whsCode2);
		condition1.setOperation(ConditionOperation.EQUAL);
		condition1.setRelationship(ConditionRelationship.AND);
		...
		condition2.setOperation(ConditionOperation.EQUAL);
		condition2 = criteria2.getConditions().create();
		condition2.setAlias(MaterialQuantity.CONDITION_ALIAS_WAREHOUSE);
		condition2.setValue(whsCode1);
		condition2.setOperation(ConditionOperation.EQUAL);
		condition2.setRelationship(ConditionRelationship.AND);
		...
		condition3.setOperation(ConditionOperation.EQUAL);
		condition3 = criteria3.getConditions().create();
		condition3.setAlias(MaterialQuantity.CONDITION_ALIAS_WAREHOUSE);
		condition3.setValue(whsCode1);
		condition3.setOperation(ConditionOperation.EQUAL);
		condition3.setBracketOpen(1);
		condition3.setRelationship(ConditionRelationship.AND);
		...
		assertEquals(opRstMaterialQuantity.getMessage(), 0, opRstMaterialQuantity.getResultCode());
		assertEquals("库存查询错误", 11100, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode1)).getOnHand().intValue());
		assertEquals("库存查询错误", 22200, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode2)).getOnHand().intValue());
		assertEquals("库存查询错误", 33300, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode3)).getOnHand().intValue());
		// endregion
		...
		condition5.setOperation(ConditionOperation.EQUAL);
		condition5 = criteria5.getConditions().create();
		condition5.setAlias(MaterialQuantity.CONDITION_ALIAS_WAREHOUSE);
		condition5.setValue(whsCode1);
		condition5.setOperation(ConditionOperation.EQUAL);
		condition5.setBracketOpen(1);
		condition5.setRelationship(ConditionRelationship.AND);
		...
		assertEquals(opRstMaterialQuantity.getMessage(), 0, opRstMaterialQuantity.getResultCode());
		assertEquals("库存查询错误", 10100, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode1)).getOnHand().intValue());
		assertEquals("库存查询错误", 20200, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode2)).getOnHand().intValue());
		assertEquals("库存查询错误", 30300, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode3)).getOnHand().intValue());
		// endregion
		// region 查询不存在物料 -> 返回成功
		ICriteria criteria6 = new Criteria();
		...
		condition8 = criteria8.getConditions().create();
		condition8.setAlias(MaterialQuantity.CONDITION_ALIAS_WAREHOUSE);
		...
		assertEquals(opRstMaterialQuantity.getMessage(), 0, opRstMaterialQuantity.getResultCode());
		assertEquals("库存查询错误", 1100, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode1)).getOnHand().intValue());
		assertEquals("库存查询错误", 2200, opRstMaterialQuantity.getResultObjects()
				.firstOrDefault(c -> c.getItemCode().equals(itemCode2)).getOnHand().intValue());
		// endregion
		// endregion
	...
	public void testFetchMaterialPriceException() throws Exception {
		...
		condition1.setOperation(ConditionOperation.EQUAL);
		condition1.setRelationship(ConditionRelationship.AND);
		IOperationResult<IMaterialPrice> opRstMaterialPrice = boRepository.fetchMaterialPrice(criteria1);
